    ...
    public partial class Giris : Form
{
    ...
    private void btn_girisYap_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("Lütfen bütün boþ alanlarý doldurun.", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        else
        {
            if (connect.State != ConnectionState.Open)
            {
                try
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(selectData, connect))
                    {
                        ...
                        {
                            MessageBox.Show("Baþarýyla giriþ yapýldý.", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                        else
                        {
                            MessageBox.Show("Þifre veya E-mail yanlýþ", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                    }
                }
                catch (Exception ex)
